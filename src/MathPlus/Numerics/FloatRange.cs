...
namespace MathPlus {
	...
	public struct FloatRange {
		...
		public float Lerp( float t ) => MathPlus.Lerp( a, b, t );
		...
		public float InverseLerp( float v ) => MathPlus.InverseLerp( a, b, v );
		...
		public FloatRange Encapsulate( float value ) =>
			Direction switch {
				1 => ( MathPlus.Min( a, value ), MathPlus.Max( b, value ) ), // forward - a is min, b is max
				_ => ( MathPlus.Min( b, value ), MathPlus.Max( a, value ) ) // reversed - b is min, a is max
			};
		...
		public FloatRange Encapsulate( FloatRange range ) =>
			Direction switch {
				1 => ( MathPlus.Min( a, range.a ), MathPlus.Max( b, range.b ) ), // forward - a is min, b is max
				_ => ( MathPlus.Min( b, range.b ), MathPlus.Max( a, range.a ) ) // reversed - b is min, a is max
			};
