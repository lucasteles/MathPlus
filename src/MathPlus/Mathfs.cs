...
namespace MathPlus {
	...
	public static class MathPlus {
		...
		/// They are considered equal if they are within a <c>MathPlus.Epsilon*8</c> or <c>max(a,b)*0.000001f</c> range of each other</summary>
		...
		/// <inheritdoc cref="MathPlus.Lerp(Vector2,Vector2,Vector2)"/>
		...
		/// <inheritdoc cref="MathPlus.InverseLerp(Vector2,Vector2,Vector2)"/>
		...
		/// <seealso cref="MathPlusExtensions.Angle"/>
