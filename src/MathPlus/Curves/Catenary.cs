...
namespace MathPlus {
	...
	public static class Catenary {
		...
		public static float Eval( float x, float a ) => a * MathPlus.Cosh( x / a );
		...
		/// <param name="a">The a-parameter of the catenary</param>
		public static float EvalArcLen( float x, float a ) => a * MathPlus.Sinh( x / a );
		...
		/// <param name="a">The a-parameter of the catenary</param>
		public static float EvalXByArcLength( float s, float a ) => a * MathPlus.Asinh( s / a );
