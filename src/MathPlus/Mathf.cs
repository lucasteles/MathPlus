...
// 
// Collected and expanded upon to by Freya Holmér (https://github.com/FreyaHolmer/MathPlus)
...
public static class Mathf
{
    ...
    [MethodImpl(Inline)] public static Vector2 Sqrt(Vector2 v) =>
        new(Sqrt(v.X), Sqrt(v.Y));

    /// <inheritdoc cref="Mathf.Sqrt(Vector2)"/>
    [MethodImpl(Inline)] public static Vector3 Sqrt(Vector3 v) =>
        new(Sqrt(v.X), Sqrt(v.Y), Sqrt(v.Z));

    /// <inheritdoc cref="Mathf.Sqrt(Vector2)"/>
    [MethodImpl(Inline)] public static Vector4 Sqrt(Vector4 v) =>
        new(Sqrt(v.X), Sqrt(v.Y), Sqrt(v.Z), Sqrt(v.W));
    ...
    [MethodImpl(Inline)] public static float Pow(float value, float exponent) =>
    ...
    [MethodImpl(Inline)] public static float Log(float value, float @base) =>
    ...
    [MethodImpl(Inline)] public static int Factorial(uint value)
    {
        ...
        if (value <= 20)
            throw new OverflowException(
                $"The Factorial of {value} is too big for integer representation, please use {nameof(FactorialLong)} instead");
        throw new OverflowException(
            $"The Factorial of {value} is too big for integer representation");
    }
    ...
    [MethodImpl(Inline)] public static long FactorialLong(uint value)
    {
        ...
        throw new OverflowException(
            $"The Factorial of {value} is too big for integer representation, even unsigned longs, soooo, rip");
    }
    ...
    [MethodImpl(Inline)] public static bool Approximately(float a, float b) =>
        Abs(b - a) < Max(0.000001f * Max(Abs(a), Abs(b)), Epsilon * 8);

    /// <inheritdoc cref="Approximately(float,float)"/>
    [MethodImpl(Inline)] public static bool Approximately(Vector2 a, Vector2 b) =>
        Approximately(a.X, b.X) && Approximately(a.Y, b.Y);

    /// <inheritdoc cref="Approximately(float,float)"/>
    [MethodImpl(Inline)] public static bool Approximately(Vector3 a, Vector3 b) =>
        Approximately(a.X, b.X) && Approximately(a.Y, b.Y) && Approximately(a.Z, b.Z);

    /// <inheritdoc cref="Approximately(float,float)"/>
    [MethodImpl(Inline)] public static bool Approximately(Vector4 a, Vector4 b) =>
        Approximately(a.X, b.X) && Approximately(a.Y, b.Y) && Approximately(a.Z, b.Z) &&
        Approximately(a.W, b.W);

    /// <inheritdoc cref="Approximately(float,float)"/>
    [MethodImpl(Inline)] public static bool Approximately(Color a, Color b) =>
    ...
    /// <summary>Returns the angle of a vector. I don't recommend using this function, it's confusing~ Use MathPlus.DirToAng instead</summary>
    ...
    public static double Cosinc(double x)
    {
        if (Math.Abs(x) < 0.01)
            return
                x / 2 - (x * x * x) /
                24; // approximate the singularity w. a polynomial, based on the taylor series expansion
    ...
    public static Rotor3 GeometricProduct(Vector3 a, Vector3 b) =>
        new(Vector3.Dot(a, b), Wedge(a, b));
    ...
    [MethodImpl(Inline)] public static Vector2 Abs(Vector2 v) => Vector2.Abs(v);

    /// <inheritdoc cref="Mathf.Abs(Vector3)"/>
    [MethodImpl(Inline)] public static Vector3 Abs(Vector3 v) => Vector3.Abs(v);

    /// <inheritdoc cref="Mathf.Abs(Vector4)"/>
    [MethodImpl(Inline)] public static Vector4 Abs(Vector4 v) => Vector4.Abs(v);
    ...
    public static double ClampNeg1to1(double value) =>
    ...
    [MethodImpl(Inline)] public static float Min(float a, float b, float c) =>
        Min(Min(a, b), c);

    /// <summary>Returns the smallest of the four values</summary>
    [MethodImpl(Inline)] public static float Min(float a, float b, float c, float d) =>
        Min(Min(a, b), Min(c, d));
    ...
    [MethodImpl(Inline)] public static float Max(float a, float b, float c) =>
        Max(Max(a, b), c);

    /// <summary>Returns the largest of the four values</summary>
    [MethodImpl(Inline)] public static float Max(float a, float b, float c, float d) =>
        Max(Max(a, b), Max(c, d));
    ...
    /// <summary>Returns the smallest of the four values</summary>
    [MethodImpl(Inline)] public static int Min(int a, int b, int c, int d) =>
        Min(Min(a, b), Min(c, d));
    ...
    /// <summary>Returns the largest of the four values</summary>
    [MethodImpl(Inline)] public static int Max(int a, int b, int c, int d) =>
        Max(Max(a, b), Max(c, d));
    ...
    [MethodImpl(Inline)] public static Vector2 Sign(Vector2 value) =>
        new(value.X >= 0f ? 1 : -1, value.Y >= 0f ? 1 : -1);

    /// <inheritdoc cref="Mathf.Sign(Vector2)"/>
    [MethodImpl(Inline)] public static Vector3 Sign(Vector3 value) =>
        new(value.X >= 0f ? 1 : -1, value.Y >= 0f ? 1 : -1, value.Z >= 0f ? 1 : -1);

    /// <inheritdoc cref="Mathf.Sign(Vector2)"/>
    [MethodImpl(Inline)] public static Vector4 Sign(Vector4 value) =>
        new(value.X >= 0f ? 1 : -1, value.Y >= 0f ? 1 : -1, value.Z >= 0f ? 1 : -1,
            value.W >= 0f ? 1 : -1);
    ...
    public static float SignWithZero(float value, float zeroThreshold = 0.000001f) =>
        Abs(value) < zeroThreshold ? 0 : Sign(value);
    ...
    [MethodImpl(Inline)] public static int SignWithZero(int value) =>
        value == 0 ? 0 : Sign(value);

    /// <summary>The sign of the value. Returns -1 if negative, return 0 if zero (or within the given threshold), returns 1 if positive</summary>
    [MethodImpl(Inline)]
    public static int SignWithZeroAsInt(float value, float zeroThreshold = 0.000001f) =>
        Abs(value) < zeroThreshold ? 0 : SignAsInt(value);
    ...
    [MethodImpl(Inline)] public static Vector2 Floor(Vector2 value) =>
        new(MathF.Floor(value.X), MathF.Floor(value.Y));

    /// <inheritdoc cref="Mathf.Floor(Vector2)"/>
    [MethodImpl(Inline)] public static Vector3 Floor(Vector3 value) =>
        new(MathF.Floor(value.X), MathF.Floor(value.Y), MathF.Floor(value.Z));

    /// <inheritdoc cref="Mathf.Floor(Vector2)"/>
    [MethodImpl(Inline)] public static Vector4 Floor(Vector4 value) =>
        new(MathF.Floor(value.X), MathF.Floor(value.Y), MathF.Floor(value.Z),
            MathF.Floor(value.W));
    ...
    [MethodImpl(Inline)] public static Vector2Int FloorToInt(Vector2 value) =>
        new((int) Math.Floor(value.X), (int) Math.Floor(value.Y));

    /// <inheritdoc cref="Mathf.FloorToInt(Vector2)"/>
    [MethodImpl(Inline)] public static Vector3Int FloorToInt(Vector3 value) =>
        new((int) Math.Floor(value.X), (int) Math.Floor(value.Y),
    ...
    [MethodImpl(Inline)] public static Vector2 Ceil(Vector2 value) =>
        new(MathF.Ceiling(value.X), MathF.Ceiling(value.Y));

    /// <inheritdoc cref="Mathf.Ceil(Vector2)"/>
    [MethodImpl(Inline)] public static Vector3 Ceil(Vector3 value) =>
        new(MathF.Ceiling(value.X), MathF.Ceiling(value.Y), MathF.Ceiling(value.Z));

    /// <inheritdoc cref="Mathf.Ceil(Vector2)"/>
    [MethodImpl(Inline)] public static Vector4 Ceil(Vector4 value) =>
        new(MathF.Ceiling(value.X), MathF.Ceiling(value.Y), MathF.Ceiling(value.Z),
    ...
    [MethodImpl(Inline)] public static Vector2Int CeilToInt(Vector2 value) =>
        new((int) Math.Ceiling(value.X), (int) Math.Ceiling(value.Y));

    /// <inheritdoc cref="Mathf.CeilToInt(Vector2)"/>
    [MethodImpl(Inline)] public static Vector3Int CeilToInt(Vector3 value) =>
        new((int) Math.Ceiling(value.X), (int) Math.Ceiling(value.Y),
    ...
    public static Vector2 Round(Vector2 value,
        MidpointRounding midpointRounding = MidpointRounding.ToEven) => new(
        MathF.Round(value.X, midpointRounding), MathF.Round(value.Y, midpointRounding));
    ...
    public static Vector3 Round(Vector3 value,
        MidpointRounding midpointRounding = MidpointRounding.ToEven) => new(
        MathF.Round(value.X, midpointRounding), MathF.Round(value.Y, midpointRounding),
        MathF.Round(value.Z, midpointRounding));

    /// <inheritdoc cref="Mathf.Round(Vector2,MidpointRounding)"/>
    [MethodImpl(Inline)]
    public static Vector4
        Round(Vector4 value, MidpointRounding midpointRounding = MidpointRounding.ToEven) =>
        new(MathF.Round(value.X, midpointRounding),
            MathF.Round(value.Y, midpointRounding), MathF.Round(value.Z, midpointRounding),
            MathF.Round(value.W, midpointRounding));
    ...
    public static float Round(float value, float snapInterval,
        MidpointRounding midpointRounding = MidpointRounding.ToEven) =>
        MathF.Round(value / snapInterval, midpointRounding) * snapInterval;

    /// <summary>Rounds the vector components to the nearest value, snapped to the given interval size</summary>
    [MethodImpl(Inline)]
    public static Vector2 Round(Vector2 value, float snapInterval,
        MidpointRounding midpointRounding = MidpointRounding.ToEven) => new(
        Round(value.X, snapInterval, midpointRounding),
        Round(value.Y, snapInterval, midpointRounding));
    ...
    public static Vector3 Round(Vector3 value, float snapInterval,
        ...
        Round(value.X, snapInterval, midpointRounding),
        Round(value.Y, snapInterval, midpointRounding),
        Round(value.Z, snapInterval, midpointRounding));

    /// <inheritdoc cref="Mathf.Round(Vector2,float,MidpointRounding)"/>
    [MethodImpl(Inline)]
    public static Vector4
        Round(Vector4 value, float snapInterval,
            MidpointRounding midpointRounding = MidpointRounding.ToEven) => new(
        Round(value.X, snapInterval, midpointRounding),
        Round(value.Y, snapInterval, midpointRounding),
        Round(value.Z, snapInterval, midpointRounding),
        Round(value.W, snapInterval, midpointRounding));
    ...
    public static Vector2Int RoundToInt(Vector2 value,
        MidpointRounding midpointRounding = MidpointRounding.ToEven) => new(
        (int) Math.Round(value.X, midpointRounding),
        (int) Math.Round(value.Y, midpointRounding));
    ...
    public static Vector3Int RoundToInt(Vector3 value,
        ...
        (int) Math.Round(value.X, midpointRounding),
        (int) Math.Round(value.Y, midpointRounding),
        (int) Math.Round(value.Z, midpointRounding));
    ...
    [MethodImpl(Inline)] public static Vector2 Frac(Vector2 v) =>
        new(v.X - Floor(v.X), v.Y - Floor(v.Y));

    /// <inheritdoc cref="Mathf.Frac(Vector2)"/>
    [MethodImpl(Inline)] public static Vector3 Frac(Vector3 v) =>
        new(v.X - Floor(v.X), v.Y - Floor(v.Y), v.Z - Floor(v.Z));

    /// <inheritdoc cref="Mathf.Frac(Vector2)"/>
    [MethodImpl(Inline)] public static Vector4 Frac(Vector4 v) => new(v.X - Floor(v.X),
        v.Y - Floor(v.Y), v.Z - Floor(v.Z), v.W - Floor(v.W));

    /// <summary>Repeats the given value in the interval specified by length</summary>
    [MethodImpl(Inline)] public static float Repeat(float value, float length) =>
    ...
    [MethodImpl(Inline)] public static int Mod(int value, int length) =>
        value >= 0 ? value % length : (value % length + length) % length;

    /// <summary>Repeats a value within a range, going back and forth</summary>
    [MethodImpl(Inline)] public static float PingPong(float t, float length) =>
        length - Abs(Repeat(t, length * 2f) - length);
    ...
    public static int Gcd(int a, int b)
    {
        ...
        if (a == int.MinValue || b == int.MinValue)
        {
            if (a == int.MinValue && b == int.MinValue)
                return
                    int.MinValue; // the only negative return value, bc we can't negate this number
            var v = Max(a, b).Abs();
            return v & -v;
        }
    ...
    [MethodImpl(Inline)] public static float Smoother01(float x) =>
        x * x * x * (x * (x * 6 - 15) + 10);
    ...
    /// <summary>Applies a gamma curve or something idk I've never used this function before but it was part of Unity's original MathPlus.cs and it's undocumented</summary>
    ...
    [MethodImpl(Inline)] public static float Lerp(float a, float b, float t) =>
        (1f - t) * a + t * b;
    ...
    [MethodImpl(Inline)] public static Vector2 Lerp(Vector2 a, Vector2 b, Vector2 t) =>
        new(Lerp(a.X, b.X, t.X), Lerp(a.Y, b.Y, t.Y));

    /// <inheritdoc cref="Mathf.Lerp(Vector2,Vector2,Vector2)"/>
    [MethodImpl(Inline)] public static Vector3 Lerp(Vector3 a, Vector3 b, Vector3 t) =>
        new(Lerp(a.X, b.X, t.X), Lerp(a.Y, b.Y, t.Y), Lerp(a.Z, b.Z, t.Z));

    /// <inheritdoc cref="Mathf.Lerp(Vector2,Vector2,Vector2)"/>
    [MethodImpl(Inline)] public static Vector4 Lerp(Vector4 a, Vector4 b, Vector4 t) =>
        new(Lerp(a.X, b.X, t.X), Lerp(a.Y, b.Y, t.Y), Lerp(a.Z, b.Z, t.Z),
            Lerp(a.w, b.w, t.w));
    ...
    [MethodImpl(Inline)] public static float LerpClamped(float a, float b, float t) =>
        Lerp(a, b, Clamp01(t));
    ...
    /// <param name="b">The start value, when t is 1</param>
    /// <param name="t">The t-value from 0 to 1 representing position along the lerp, clamped between 0 and 1</param>
    [MethodImpl(Inline)] public static float LerpSmooth(float a, float b, float t) =>
        Lerp(a, b, Smooth01(Clamp01(t)));
    ...
    [MethodImpl(Inline)] public static float InverseLerp(float a, float b, float value) =>
        (value - a) / (b - a);
    ...
    [MethodImpl(Inline)] public static Vector2 InverseLerp(Vector2 a, Vector2 b, Vector2 v) =>
        new((v.X - a.X) / (b.X - a.X), (v.Y - a.Y) / (b.Y - a.Y));

    /// <inheritdoc cref="Mathf.InverseLerp(Vector2,Vector2,Vector2)"/>
    [MethodImpl(Inline)] public static Vector3 InverseLerp(Vector3 a, Vector3 b, Vector3 v) =>
        new((v.X - a.X) / (b.X - a.X), (v.Y - a.Y) / (b.Y - a.Y),
            (v.Z - a.Z) / (b.Z - a.Z));

    /// <inheritdoc cref="Mathf.InverseLerp(Vector2,Vector2,Vector2)"/>
    [MethodImpl(Inline)] public static Vector4 InverseLerp(Vector4 a, Vector4 b, Vector4 v) =>
        new((v.X - a.X) / (b.X - a.X), (v.Y - a.Y) / (b.Y - a.Y),
            (v.Z - a.Z) / (b.Z - a.Z), (v.W - a.W) / (b.W - a.W));
    ...
    /// <param name="b">The end of the range, where it would return 1</param>
    /// <param name="value">A value between a and b. Note: values outside this range are still valid, and will be extrapolated</param>
    [MethodImpl(Inline)] public static float InverseLerpSmooth(float a, float b, float value) =>
    ...
    [MethodImpl(Inline)]
    public static Vector2 Remap(Vector2 iMin, Vector2 iMax, Vector2 oMin, Vector2 oMax,
        Vector2 value) => Lerp(oMin, oMax, InverseLerp(iMin, iMax, value));

    /// <inheritdoc cref="Mathf.Remap(Vector2,Vector2,Vector2,Vector2,Vector2)"/>
    [MethodImpl(Inline)]
    public static Vector3 Remap(Vector3 iMin, Vector3 iMax, Vector3 oMin, Vector3 oMax,
        Vector3 value) => Lerp(oMin, oMax, InverseLerp(iMin, iMax, value));

    /// <inheritdoc cref="Mathf.Remap(Vector2,Vector2,Vector2,Vector2,Vector2)"/>
    [MethodImpl(Inline)]
    public static Vector4 Remap(Vector4 iMin, Vector4 iMax, Vector4 oMin, Vector4 oMax,
        Vector4 value) => Lerp(oMin, oMax, InverseLerp(iMin, iMax, value));
    ...
    public static float RemapClamped(float iMin, float iMax, float oMin, float oMax,
        float value) => Lerp(oMin, oMax, InverseLerpClamped(iMin, iMax, value));
    ...
    [MethodImpl(Inline)] public static Vector2 Remap(Rect iRect, Rect oRect, Vector2 iPos) =>
    ...
    public static Vector3 Remap(Bounds iBounds, Bounds oBounds, Vector3 iPos) =>
        Remap(iBounds.Min, iBounds.Max, oBounds.Min, oBounds.Max, iPos);
    ...
    public static float Remap(FloatRange inRange, FloatRange outRange, float value) =>
        Remap(inRange.Start, inRange.End, outRange.Start, outRange.End, value);
    ...
    public static float RemapClamped(FloatRange inRange, FloatRange outRange, float value) =>
        RemapClamped(inRange.Start, inRange.End, outRange.Start, outRange.End, value);
    ...
    [MethodImpl(Inline)] public static float WeightedSum(Vector2 w, float a, float b) =>
        a * w.X + b * w.Y;
    ...
    [MethodImpl(Inline)]
    public static float WeightedSum(Vector3 w, float a, float b, float c) =>
        a * w.X + b * w.Y + c * w.Z;
    ...
    [MethodImpl(Inline)]
    public static float WeightedSum(Vector4 w, float a, float b, float c, float d) =>
        a * w.X + b * w.Y + c * w.Z + d * w.W;

    /// <summary>Multiplies each component of <c>w</c> by the input values, and returns their sum</summary>
    /// <param name="w">The weights (per component) to apply to the rest of the values</param>
    /// <param name="a">The first value, weighted by <c>w.x</c></param>
    /// <param name="b">The second value, weighted by <c>w.y</c></param>		
    [MethodImpl(Inline)] public static Vector2 WeightedSum(Vector2 w, Vector2 a, Vector2 b) =>
        a * w.X + b * w.Y;
    ...
    /// <param name="c">The third value, weighted by <c>w.z</c></param>
    [MethodImpl(Inline)]
    public static Vector2 WeightedSum(Vector3 w, Vector2 a, Vector2 b, Vector2 c) =>
        a * w.X + b * w.Y + c * w.Z;
    ...
    /// <param name="a">The first value, weighted by <c>w.x</c></param>
    /// <param name="b">The second value, weighted by <c>w.y</c></param>
    [MethodImpl(Inline)] public static Vector3 WeightedSum(Vector3 w, Vector3 a, Vector3 b) =>
        a * w.X + b * w.Y;
    ...
    /// <param name="a">The first value, weighted by <c>w.x</c></param>
    /// <param name="b">The second value, weighted by <c>w.y</c></param>
    [MethodImpl(Inline)] public static Vector4 WeightedSum(Vector4 w, Vector4 a, Vector4 b) =>
        a * w.X + b * w.Y;
    ...
    /// <param name="c">The third value, weighted by <c>w.z</c></param>
    [MethodImpl(Inline)]
    public static Vector4 WeightedSum(Vector4 w, Vector4 a, Vector4 b, Vector4 c) =>
        a * w.X + b * w.Y + c * w.Z;
    ...
    /// <param name="d">The fourth value, weighted by <c>w.w</c></param>
    [MethodImpl(Inline)]
    public static Vector4 WeightedSum(Vector4 w, Vector4 a, Vector4 b, Vector4 c, Vector4 d) =>
        a * w.X + b * w.Y + c * w.Z + d * w.W;
    ...
    [MethodImpl(Inline)] public static float ChebyshevDistance(Vector3 a, Vector3 b) =>
        Max(Abs(a.X - b.X), Abs(a.Y - b.Y), Abs(a.Z - b.Z));

    /// <summary>Returns the taxicab/rectilinear distance between the two vectors</summary>
    [MethodImpl(Inline)] public static float TaxicabDistance(Vector3 a, Vector3 b) =>
        Abs(a.X - b.X) + Abs(a.Y - b.Y) + Abs(a.Z - b.Z);

    /// <inheritdoc cref="ChebyshevDistance(Vector2,Vector2)"/>
    [MethodImpl(Inline)] public static float ChebyshevDistance(Vector2 a, Vector2 b) =>
        Max(Abs(a.X - b.X), Abs(a.Y - b.Y));

    /// <inheritdoc cref="TaxicabDistance(Vector2,Vector2)"/>
    [MethodImpl(Inline)] public static float TaxicabDistance(Vector2 a, Vector2 b) =>
    ...
    [MethodImpl(Inline)] public static Vector2 AverageDir(Vector2 aDir, Vector2 bDir) =>
        (aDir + bDir).Normalized();

    /// <inheritdoc cref="AverageDir(Vector2,Vector2)"/>
    [MethodImpl(Inline)] public static Vector3 AverageDir(Vector3 aDir, Vector3 bDir) =>
        (aDir + bDir).Normalized();
    ...
    [MethodImpl(Inline)] public static float DistanceSquared(Vector2 a, Vector2 b) =>
        (a.X - b.X).Square() + (a.Y - b.Y).Square();

    /// <inheritdoc cref="DistanceSquared(Vector2,Vector2)"/>
    [MethodImpl(Inline)] public static float DistanceSquared(Vector3 a, Vector3 b) =>
        (a.X - b.X).Square() + (a.Y - b.Y).Square() + (a.Z - b.Z).Square();

    /// <inheritdoc cref="DistanceSquared(Vector2,Vector2)"/>
    [MethodImpl(Inline)] public static float DistanceSquared(Vector4 a, Vector4 b) =>
        (a.X - b.X).Square() + (a.Y - b.Y).Square() + (a.Z - b.Z).Square() +
        (a.W - b.W).Square();
    ...
    [MethodImpl(Inline)] public static Vector2 AngToDir(float aRad) =>
        new(MathF.Cos(aRad), MathF.Sin(aRad));
    ...
    [MethodImpl(Inline)] public static Quaternion DirToOrientation(Vector2 v)
    {
        ...
        a.X += 1;
        var b = a.Normalized();
        return new Quaternion(0, 0, b.Y, b.X);
    }

    /// <summary>The angle between two quaternions, in radians</summary>
    public static float Angle(Quaternion a, Quaternion b)
    {
        var num = Min(Abs(Quaternion.Dot(a, b)), 1f);
    ...
    /// <param name="v">The direction to create a 2D orientation from (does not have to be normalized)</param>
    [MethodImpl(Inline)] public static Pose PointDirToPose(Vector2 pt, Vector2 v) =>
        new(pt.ToVector3(), DirToOrientation(v));
    ...
    public static float GetTorsion(Vector3 velocity, Vector3 acceleration, Vector3 jerk)
    {
        ...
        return Vector3.Dot(cVector, jerk) / cVector.LengthSquared();
    }
    ...
    /// <param name="acceleration">The second derivative of the point in the curve</param>
    [MethodImpl(Inline)]
    public static Vector3 GetArcNormal(Vector3 velocity, Vector3 acceleration) =>
        Vector3.Cross(Vector3.Cross(velocity, acceleration).Normalized(),
            velocity.Normalized());
    ...
    /// <param name="acceleration">The second derivative of the point in the curve</param>
    [MethodImpl(Inline)]
    public static Vector3 GetArcBinormal(Vector3 velocity, Vector3 acceleration) =>
        Vector3.Cross(velocity, acceleration).Normalized();
    ...
    [MethodImpl(Inline)]
    public static Vector3 GetNormalFromLookTangent(Vector3 tangent, Vector3 up) =>
    ...
    [MethodImpl(Inline)]
    public static Quaternion GetArcOrientation(Vector2 velocity, Vector2 acceleration)
    {
        var binormal = new Vector3(0, 0, Sign(Determinant(velocity, acceleration)));
        return Quaternion.LookRotation(velocity, binormal);
    }
    ...
    /// <param name="acceleration">The second derivative of the point in the curve</param>
    [MethodImpl(Inline)]
    public static Quaternion GetFrenetSerretOrientation(Vector3 velocity, Vector3 acceleration)
    {
        GetCurvatureOrientationAxes(velocity, acceleration, out _, out var N,
            out var B);
    ...
    [MethodImpl(Inline)]
    public static Quaternion GetFrenetSerretOrientation(Vector2 velocity, Vector2 acceleration)
    {
        GetCurvatureOrientationAxes(velocity, acceleration, out _, out var N,
            out var B);
        return Quaternion.LookRotation(B, N);
    ...
    [MethodImpl(Inline)] public static void GetCurvatureOrientationAxes(Vector3 velocity,
        Vector3 acceleration, out Vector3 tangent, out Vector3 normal, out Vector3 binormal)
    {
    ...
    [MethodImpl(Inline)] public static void GetCurvatureOrientationAxes(Vector2 velocity,
        Vector2 acceleration, out Vector3 tangent, out Vector3 normal, out Vector3 binormal)
    {
        tangent = velocity.Normalized().ToVector3();
        var sign = Sign(Determinant(velocity, acceleration));
    ...
    {
        var sign = Determinant(forward, up) >= 0 ? 1 : -1;
    ...
    [MethodImpl(Inline)] public static Quaternion GetLookRotation2D(Vector2 forward) =>
        GetLookRotation2D(forward, Vector2.up);

    /// <summary>Returns the signed angle between <c>a</c> and <c>b</c>, in the range -tau/2 to tau/2 (-pi to pi)</summary>
    [MethodImpl(Inline)] public static float SignedAngle(Vector2 a, Vector2 b) =>
        AngleBetween(a, b) * MathF.Sign(Determinant(a, b)); // -tau/2 to tau/2

    /// <summary>Returns the shortest angle between <c>a</c> and <c>b</c>, in the range 0 to tau/2 (0 to pi)</summary>
    [MethodImpl(Inline)] public static float AngleBetween(Vector2 a, Vector2 b) =>
        MathF.Acos(Vector2.Dot(a.Normalized(), b.Normalized()).ClampNeg1To1());

    /// <inheritdoc cref="AngleBetween(Vector2,Vector2)"/>
    [MethodImpl(Inline)] public static float AngleBetween(Vector3 a, Vector3 b) =>
    ...
    [MethodImpl(Inline)] public static float AngleFromToCW(Vector2 from, Vector2 to) =>
        Determinant(from, to) < 0 ? AngleBetween(from, to) : TAU - AngleBetween(from, to);

    /// <summary>Returns the counterclockwise angle between <c>from</c> and <c>to</c>, in the range 0 to tau (0 to 2*pi)</summary>
    [MethodImpl(Inline)] public static float AngleFromToCCW(Vector2 from, Vector2 to) =>
        Determinant(from, to) > 0 ? AngleBetween(from, to) : TAU - AngleBetween(from, to);
    ...
    [MethodImpl(Inline)] public static float DeltaAngle(float a, float b) =>
